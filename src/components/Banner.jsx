...
const Banner = () => {
  ...
  const handleSelectBeds = (item) => {
    setSelectedBeds((prev) =>
      prev.includes(item) ? prev.filter((bed) => bed !== item) : [...prev, item]
    );
  };
    ...
    <div className="min-h-screen bg-gray-200 relative">
      ...
      <div className="absolute left-24 top-40 ">
        <div className="flex flex-col gap-4 lg:gap-20">
          ...
          <div className="">
            <div className="relative bg-white hidden text-black max-w-fit font-montserrat lg:flex rounded-lg text-sm md:text-lg lg:text-xl ml-11 border-b-1 border-gray-500">
              <button
                type="button"
                className={`max-w-fit py-0 px-5 rounded-tl-lg flex-1 border-r border-b ${
                  tabs === 1 ? "bg-teal-500 text-white text-sm" : "bg-white text-teal-500 text-sm"
                }`}
                onClick={() => setTabs(1)}
              >
                Buy
              ...
              <button
                type="button"
                className={`max-w-fit py-0 px-5 flex-1 border-r border-b ${
                  tabs === 2 ? "bg-teal-500 text-white text-sm" : "bg-white text-teal-500 text-sm"
                }`}
                onClick={() => setTabs(2)}
              >
                Rent
              ...
              <button
                type="button"
                className={`max-w-fit py-1 px-5 border-b flex-1 rounded-tr-lg ${
                  tabs === 3 ? "bg-teal-500 text-white text-sm" : "bg-white text-teal-500 text-sm"
                }`}
                onClick={() => setTabs(3)}
              >
                Projects
              ...
              <div className="bg-white py-2 hidden lg:flex items-center px-5  rounded-2xl">
                <div className="" >
                  <div className="flex flex-col gap-0  items-start relative">
                    <span className="font-davidLibre font-semibold text-sm md:text-lg lg:text-sm pl-3">
                      Location
                    </span>
                    <input
                      type="text"
                      ...
                      placeholder="Downtow|..."
                      className="text-sm md:text-sm pt-1 lg:text-sm line-clamp-1 placeholder:text-xs placeholder:text-customBlue outline-none focus:outline-none border-none h-7 focus:ring-0"
                    />
                    {text && (
                      <button
                        type="button"
                ...
                <div className="relative inline-block text-left w-40">
                  <div
                    ...
                    className="flex items-center justify-between cursor-pointer w-full px-4 py-2 text-sm font-medium text-gray-700 bg-white rounded-md   focus:outline-none border-none"
                  >
                    <div className="flex w-full justify-between items-center">
                      <div className="flex flex-col items-start">
                        <span className="font-davidLibre font-semibold text-sm md:text-lg lg:text-sm">
                          Type
                        </span>
                        <div className="  pt-1 text-xs text-customBlue font-davidLibre">
                ...
                <div className="relative inline-block text-left w-48 h-full ">
                  <div
                    onClick={() => toggleDropdown("bedsAndBaths")}
                    className="flex justify-between cursor-pointer w-full px-4  text-sm font-medium text-gray-700 bg-white rounded-md   focus:outline-none border-none"
                  >
                    <div className="flex w-full justify-between items-center">
                      <div className="flex flex-col items-start">
                        <span className="font-davidLibre font-semibold text-sm md:text-lg lg:text-sm">
                        ...
                        <div className="text-xs text-customBlue pt-1">
                    ...
                    <div className="absolute right-0 z-10 w-full bg-white rounded-md shadow-lg ring-1 ring-black ring-opacity-20 focus:outline-none">
                      <div className="py-1">
                        ...
                        <div className="flex overflow-x-auto gap-2 scrollbar-thin p-2">
                          {reorderBedrooms(bedroomsOptions).map(
                            (bed, index) => (
                              <button
                                key={index}
                ...
                <div>
                  <Button className="bg-teal-400 rounded-full px-4 py-0">
